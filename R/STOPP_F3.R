#' Evaluates the imported patients' data for the STOPP F3 criterion.
#'
...
STOPP_F3 <- function(path = NULL, excel_out = TRUE, export_data_path = NULL, suppressNA = TRUE) {
  ...
  for ( i in 1: length(pdata)){
    ...
    if (is.na(match( pid, names(sapply(missing_data_patients, names))))){ # checking if missing_data_patients contain pid
      ...
      if ( any(grepl('R06AA02|R06AA04|R06AA52|R06AA54|R06AB02|R06AB03|R06AB04|R06AB52|R06AB54|R06AC04|R06AD01|R06AD02|R06AD52|R06AD08|R06AE03|R06AE53|R06AE04|R06AE05|R06AE55|R06AE06|R06AX02|R06AX15|R06AX17|N05BB01|N05BB51|N07CA02|N07CA52|G04BD04|G04BD07|G04BD08|G04BD10|G04BD11|G04BD02|A03BB01|^N06AA|N04BB01|N06AA09|A03BA01|M03BX01|N04AA01|N04AC01|N04AA02|N03AF01|N05AA01|N06AA04|C01BA03|N06AA16|N06AA12|N05AD01|N06AA02|A07DA03|N06AA10|N05AH03|N05AX13|N06AB05|N05AC01|N02CX01|N05AB04|A03AB05|N05AH04|N05AX08|N05AB06|N05AE04|^B03AA|^B03AB|^B03AD|^B03AE|^N02A|N07BC05|N07BC06|N07BC02|N07BC01|R05DA04|C08DA01|C08DA51|C09BB10|^A02AB', unlist(pdata[[i]][1]), ignore.case=T)) & # checking at least one condition in the antichol list
           (
             any(grepl('K59.0', unlist(pdata[[i]][2]), ignore.case=T)) | # checking K59.0 in the ih_icd10_decod list
             any(grepl('K59.0', unlist(pdata[[i]][3]), ignore.case=T))   # checking K59.0 the h_icd10_decod list
           )
         )
      {
  ...
  if (suppressNA) {
    cat('STOPP F3: ', fulfill_count, 'patients out of', total_count + missing_count, 'patients meet the criterion.\n')
  } else {
    cat('STOPP F3: ', fulfill_count, 'patients out of', total_count, 'patients meet the criterion.', missing_count, 'patients have missing data. \n')
  }

  if (excel_out) {
    # export the evaluated list of patients to excel file
    write_xlsx(evaluated_patients, path = paste0( export_data_path, '/STOPP-F3.xlsx'), col_names = TRUE)
  }
