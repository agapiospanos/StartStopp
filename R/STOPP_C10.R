...
STOPP_C10 <- function(path, excel_out = TRUE, export_data_path=getwd()) {
  ...
  cat ('STOPP C10: ', fulfill_count, 'patients out of', total_count, 'patients fulfill the criterion.', missing_count, 'patients have missing data. \n')
