...
STARTSTOPPbycategory <- function (path = NULL, STARTexclude = NULL, STOPPexclude = NULL, excel_out = TRUE, single_excel = TRUE, export_data_path = NULL, suppressNA = TRUE) {
  ...
  misuse  <- c( 'STOPP B2', 'STOPP B3', 'STOPP B4', 'STOPP B5', 'STOPP B6', 'STOPP B8', 'STOPP B9', 'STOPP B10', 'STOPP B11', 'STOPP B12', 'STOPP B13', 'STOPP C1', 'STOPP C2', 'STOPP C3',
                ...
                'STOPP E4', 'STOPP E5', 'STOPP E6', 'STOPP F1', 'STOPP F3', 'STOPP F4', 'STOPP G1', 'STOPP G2', 'STOPP G3', 'STOPP G4', 'STOPP H1', 'STOPP H2', 'STOPP H3', 'STOPP H4', 'STOPP H6',
