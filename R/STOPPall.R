...
STOPPall <- function(path = NULL, exclude = NULL, excel_out = TRUE, single_excel = TRUE, export_data_path = NULL, suppressNA = TRUE, returnData = FALSE) {

  output <- STOPPselected(selected = "all", exclude, path, excel_out, single_excel, export_data_path, suppressNA, returnData)
